...
\newcommand{\summarySection}{%
  \section{Summary}
  \small{
    Software engineer with 10+ years of experience building large-scale distributed systems and machine learning infrastructure. Currently at Google, working on TensorFlow and Apache Beam. Passionate about data pipelines, recommendation systems, and developer tooling.     Holds an M.S. in Computer Science from Georgia Tech with a 4.0 GPA.
  }\vspace{-5pt}
}
...
\newcommand{\skillsSection}{%
  \section{Skills}
  \resumeSubHeadingListStart
    \resumeSubItem{Languages}{Scala, Python, JavaScript, C++, SQL, Java}
    \resumeSubItem{Technologies}{AWS, Play, React, Kafka, GCE}
  \resumeSubHeadingListEnd
}
